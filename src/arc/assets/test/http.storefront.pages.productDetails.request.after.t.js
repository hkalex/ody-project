...
var actionName = 'http.storefront.pages.productDetails.request.after';

describe('http.storefront.pages.productDetails.request.after implementing http.storefront.pages.productDetails.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.productDetails.request.after');
  });
