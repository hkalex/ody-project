...
var actionName = 'http.storefront.pages.cmspage.request.after';

describe('cmspage_request_after implementing http.storefront.pages.cmspage.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/cmspage_request_after');
  });
