...
describe('global_request_after implementing http.storefront.pages.global.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/global_request_after');
  });
